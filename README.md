...
## I have written this guide from my own lab configuration.  So, it is oppinionated toward a libvirt/KVM installation on CentOS 7 --- Upgrading to CentOS 8, merging changes soon, follow the `ipxe` branch for the CentOS 8 upgrade.
